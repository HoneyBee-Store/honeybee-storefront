        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapUrl = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitAr = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    UnitEn = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "decimal(10,3)", precision: 10, scale: 3, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AltAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    AltEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    FocalY = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameSnapshot = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    SizeKg = table.Column<decimal>(type: "decimal(6,3)", precision: 6, scale: 3, nullable: false),
                    UnitPriceSnapshot = table.Column<decimal>(type: "decimal(10,3)", precision: 10, scale: 3, nullable: true),
