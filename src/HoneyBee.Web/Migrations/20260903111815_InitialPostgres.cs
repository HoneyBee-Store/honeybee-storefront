        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapUrl = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitAr = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    UnitEn = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_PickupLocations_PickupLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AltAr = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    AltEn = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    FocalY = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameSnapshot = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    SizeKg = table.Column<decimal>(type: "numeric(6,3)", precision: 6, scale: 3, nullable: false),
                    UnitPriceSnapshot = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: true),
